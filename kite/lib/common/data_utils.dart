...
List forceList(Map json, String key) {
...
Future<Map<String, dynamic>> bgDecodeJson(String data){
  return Isolate.run(() async {
    return jsonDecode(data);
  }, debugName: "decodeJson",);
}
...
Set<String> setOfCountries() {
  return listOfCountries().map((c) => c.toLowerCase()).toSet();
}

bool isCountry(String country) {
  return setOfCountries().contains(country.toLowerCase());
}